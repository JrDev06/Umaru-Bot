...
module.exports.loader = (data, option) => {
    switch (option) {
        case "success":
            console.log(chalk.bold.hex("#90EE90")(gradientBold('[ Umaru Chan ] ❯ \n') + data));
            break;
        case "warn":
            console.log(chalk.bold.hex("#FFA500")(gradientBold('[ Umaru Chan ] ❯ \n') + data));
            break;
        case "error":
            console.log(chalk.bold.hex("#FF0000")(gradientBold('[ Umaru Chan ] ❯ \n') + data));
            break;
        default:
            var gradText = gradientBold(`[ Umaru Chan ] ❯ \n${data}`);
            console.log(gradText);
            break;
    }
} 